<?php
    ...
    if (isset($_GET['search']) && isset($_SESSION['area'])) {
		...
		$sql ="SELECT sid,name,image FROM services JOIN area_map ON area_map.ser_id = services.sid WHERE area_map.area_id=".$_SESSION['area']." AND lower(name) LIKE lower('".$q."%') GROUP BY sid;";
    ...
    <br>
        ...
        <div class="col-sm-10 col-md-offset-3 col-md-6">
        	<form action="search.php" method="get">
				<input type="text" class="form-control" name="search" placeholder="Search for Service" value="<?php echo $_GET['search']; ?>"> <center> <input class="btn btn-default" type="button" 
				value="Search" ></center>
			</form>
        </div>
    </div>
